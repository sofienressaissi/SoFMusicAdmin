...
import { FaApple, FaDoorOpen, FaFileVideo, FaFolder, FaFolderPlus, FaMusic, FaSpotify, FaStar, FaVideo } from 'react-icons/fa';
...
export default function AllReleases() {
    ...
    let [allReleases, setAllReleases] = useState([]);
    ...
    return (
        <>
        {
            ...
            <html>
            <head>
                <title>SoF Music - All Releases</title>
                              ...
                              <div className="row align-items-center">
                                  ...
                                  <div className="col-md-4">
                                      <ul className="breadcrumb-title">
                                          ...
                                          <li className="breadcrumb-item"><a >All Releases</a>
                                          </li>
                                      </ul>
                                  </div>
                                                        ...
                                                        <tbody>
                                                            {
                                                                currentRlsData.filter((item=>{
                                                                    ...
                                                                    <tr key={itemr._id}>
                                                                    <td>
                                      <img src={`${itemr.releaseCover}`}
                                     alt={`${itemr.coverName}`} width="100px" height="100px" style={{marginTop: '-4px'}}/>
                                                                    </td>
                                                                    
                                                                    <td>
                                                                        {capitalizeFirstLetter(itemr.releaseType)}
                                                                    </td>
                                                                    <td>
                                                                        {itemr.releaseName}
                                                                    </td>
                                                                    <td>
                                                                         {itemr.tracks.map(itemtt => (
                                                                             <>{itemtt.trackName}<br/></>
                                                                         ))}                                                 
                                                                    </td>
                                                                    <td>
                                                                        <a href = {itemr.spLink} target="_blank" title = "Spotify">
                                                                            <FaSpotify/>
                                                                        </a>&nbsp;&nbsp;&nbsp;
                                                                        <a href = {itemr.spLink} target="_blank" title = "Deezer">
                                                                            <FaMusic/>
                                                                        </a>&nbsp;&nbsp;&nbsp;
                                                                        {
                                                                            !itemr.amLink ?
                                                                            ...
                                                                            <span aria-disabled><FaApple/></span>
                                                                            </a>
                                                                            </> : <>
                                                                            <a href = {itemr.amLink} target="_blank" title = "Apple Music">
                                                                            <FaApple/>
                                                                            </a>
                                                                            </>
                                                                        }
